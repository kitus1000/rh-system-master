...
import { Send, MessageCircle, Rss, User, Check, CheckCheck, MessageSquare, ThumbsUp, Heart, Laugh, Plus, CheckSquare, Square, Globe, Shield, Users, Building } from 'lucide-react'
...
export default function ChatMuroPage() {
    ...
    async function toggleTaskStatus(post: any) {
        if (!profile || (post.id_autor !== profile.id && profile.rol !== 'Administrativo')) return // Only author/admin can mark done
                            ...
                            {selectedContact ? (
                                <>
                                    ...
                                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                                        {messages.map(msg => {
                                            const isMe = profile && msg.id_remitente === profile.id
                                            return (
